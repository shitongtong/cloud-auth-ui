<template>
  <div class="page">
    ...
    <div class="intro">
      <p>代码生成器，可以通过界面配置快速生成包括 entity、mapper、xml、service、controller 以及页面的相关代码</p>
      <p>项目地址：
        <br/>
        后端: <a href="https://github.com/shitongtong/generator-back">https://github.com/shitongtong/generator-back</a>
        <br/>
        前端: <a href="https://github.com/shitongtong/generator-front">https://github.com/shitongtong/generator-front</a>
        <br/>
